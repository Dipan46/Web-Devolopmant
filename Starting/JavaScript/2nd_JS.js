...
console.log("The value of num1 * num2 is " + (num1 * num2));
console.log("The value of num1 / num2 is " + (num1 / num2));
console.log("The value of num1 **(power) num2 is " + (num1 ** num2));
console.log("The value of num1++(post increment) is " + (num1++));
console.log("The value of ++num1(pre increment) is " + (++num1));
console.log("The value of num1--(post decrement) is " + (num1--));
console.log("The value of --num1(pre decrement) is " + (--num1));
